...
raven.config('https://3d226af42eff4927a6d026a0d639194b:7e10049f8b3e4ea1938076cd705c00af@sentry.io/197200').install();
...
server.get('/fetch/file', (req, res, next) => {
...
const getJSON = (html) => {
  ...
  const $body = $('body');
  const $script = $body.find('script').eq(0).text();
